 ...
 */
public class ModooDataUtils {
    static ArrayList<ModooItemList> wishlist = new ArrayList<>();
    static ArrayList<ModooItemList> cartList = new ArrayList<>();
    ...
    public static List<String> getOffersUrls() {
        String[] urls = new String[]{
    ...
    public static List<String> getHomeApplianceUrls() {
        String[] urls = new String[]{
                "https://static.pexels.com/photos/1778/numbers-time-watch-white-medium.jpg",
    ...
    public static List<String> getElectronicsUrls() {
        String[] urls = new String[]{
    ...
    public static List<String> getLifeStyleUrls() {
        String[] urls = new String[]{
    ...
    public static List<String> getBooksUrls() {
        String[] urls = new String[]{
                "https://static.pexels.com/photos/67442/pexels-photo-67442-medium.jpeg",
                "https://static.pexels.com/photos/159494/book-glasses-read-study-159494-medium.jpeg",
    ...
    public void addWishlist(ModooItemList modooItemList) {
        this.wishlist.add(0,modooItemList);
    }
    ...
    public void removeWishlist(ModooItemList modooItemList) {
        this.wishlist.remove(modooItemList);
    }

    public ArrayList<ModooItemList> getWishlist(){ return this.wishlist; }

    // Methods for Cart
    public void addCartList(ModooItemList modooItemList) {
        this.cartList.add(0,modooItemList);
    }
    ...
    public ArrayList<ModooItemList> getCartList(){ return this.cartList; }

    //local test
    public static String getListDataTest(int category){
        String testJsonStr = "";
    ...
    //local test
    public static String getDetailDataTest(String itemCode){
        String testJsonStr = "";
