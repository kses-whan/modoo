@echo Will you install apk file to the device after compiling?
@set /p YN=(Y/N)?
del /q /s AppRelease\Build\ > nul
mkdir AppRelease\Build\app\src\main\java\com\icure\kses\modoodev
...
START /MIN /WAIT .\tools\Utils\fnr.exe --silent --cl --dir "%CD%\AppRelease\Build\app" --fileMask "build.gradle" --caseSensitive --find ">modoo<" --replace ">modoodev<"
...
START /MIN /WAIT .\tools\Utils\fnr.exe --silent --cl --dir "%CD%\AppRelease\Build\app" --fileMask "allatori.xml" --caseSensitive --find "com.icure.kses.modoo" --replace "com.icure.kses.modoodev"

xcopy app\src\main\java\com\icure\kses\modoo\*.* AppRelease\Build\app\src\main\java\com\icure\kses\modoodev\ /e /s /y
...
mkdir AppRelease\Build\app\src\main\aidl\com\icure\kses\modoodev
xcopy app\src\main\aidl\com\icure\kses\modoo\*.* AppRelease\Build\app\src\main\aidl\com\icure\kses\modoodev\ /e /s /y
...
START /MIN /WAIT .\tools\Utils\fnr.exe --silent --cl --dir "%CD%\AppRelease\Build" --fileMask "*.*" --includeSubDirectories --skipBinaryFileDetection --caseSensitive --find "com.icure.kses.modoo" --replace "com.icure.kses.modoodev"
...
xcopy AppRelease\Modoo-DEV\*.* AppRelease\Build\  /e /s /y

START /MIN /WAIT .\tools\Utils\fnr.exe --silent --cl --dir "%CD%\AppRelease\Build" --fileMask "AndroidManifest.xml" --includeSubDirectories --caseSensitive --skipBinaryFileDetection --find "app_name" --replace "app_name_dev"
